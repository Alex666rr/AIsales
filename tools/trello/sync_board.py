...
ROADMAP_CARDS = (
    ...
    RoadmapCard("NOW.01", "Следующий блок — веб-приложение и администрирование", CURRENT_LIST, "Следующее", "Собрать защищённую web-оболочку и административные сценарии Stage 1.", STAGE_1_PLAN, "Начать с организации staff-приглашений и web shell."),
    *_stage_cards("S0", STAGE_0_LIST, STAGE_0_PLAN, (
    ...
    RoadmapCard("S1.03", "Веб-приложение и администрирование", STAGE_1_LIST, "Следующее", "Сделать web shell и безопасное управление staff.", STAGE_1_PLAN, "Согласовать и реализовать приглашения staff, затем административный интерфейс."),
