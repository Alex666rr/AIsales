...
ALTER ROLE ai_sales_owner WITH LOGIN NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT NOREPLICATION NOBYPASSRLS;
ALTER ROLE ai_sales_runtime WITH LOGIN NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT NOREPLICATION NOBYPASSRLS;
...
GRANT USAGE, CREATE ON SCHEMA public TO ai_sales_owner;
SQL
